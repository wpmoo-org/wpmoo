...
abstract class AssetEnqueuer {
     ...
     * @return void
     */
    protected function enqueue_style(string $handle, string $src, array $deps = [], ?string $version = null, string $media = 'all'): void {
     ...
     * @return void
     */
    protected function enqueue_script(string $handle, string $src, array $deps = [], ?string $version = null, bool $in_footer = true): void {
     ...
     * @return void
     */
    protected function register_style(string $handle, string $src, array $deps = [], ?string $version = null, string $media = 'all'): void {
     ...
     * @return void
     */
    protected function register_script(string $handle, string $src, array $deps = [], ?string $version = null, bool $in_footer = true): void {
