...
class Section {
	 ...
	 * @return static
	 */
	public static function make( string $id_or_title, ?string $title = null, string $description = '' ): self {
		if ( null === $title || '' === $title ) {
			return new self( $id_or_title, $id_or_title, $description );
		}

		return new self( $id_or_title, $title, $description );
	}
